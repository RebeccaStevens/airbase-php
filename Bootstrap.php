...
class Bootstrap {
		...
		$this->_url =
			...
			? explode('/',								// explode the url at the '/'s
				filter_var(								// sanitize the url
					rtrim($url, '/'),					// remove any '/'s from the end of the url
					FILTER_SANITIZE_URL))
	 ...
	 * If their is no next part of the url, then call the default function (the index function).
	 */
